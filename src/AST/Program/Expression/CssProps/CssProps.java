...
public class CssProps implements Node {
    ...
    public String generateJs(Boolean checkIfInDiv, Boolean firstDiv, Boolean isFatherFunction, String fatherName, Boolean myFatherIsIf, Boolean divAfterJSX, String changeState) {
        ...
        if (top != null) {
            js.append(top.generateJs(checkIfInDiv, firstDiv, isFatherFunction, fatherName, false, false, ""));
        }

        if (bottom != null) {
            js.append(bottom.generateJs(checkIfInDiv, firstDiv, isFatherFunction, fatherName, false, false, ""));
        }

        if (right != null) {
            js.append(right.generateJs(checkIfInDiv, firstDiv, isFatherFunction, fatherName, false, false, ""));
        }

        if (left != null) {
            js.append(left.generateJs(checkIfInDiv, firstDiv, isFatherFunction, fatherName, false, false, ""));
        }
        ...
        if (gabDash != null) {
            js.append(gabDash.generateJs(checkIfInDiv, firstDiv, isFatherFunction, fatherName, false, false, ""));
        }

        if (borderDash != null) {
            js.append(borderDash.generateJs(checkIfInDiv, firstDiv, isFatherFunction, fatherName, false, false, ""));
        }

        if (borderBottomDash != null) {
            js.append(borderBottomDash.generateJs(checkIfInDiv, firstDiv, isFatherFunction, fatherName, false, false, ""));
        }
        ...
        if (marginDash != null) {
            js.append(marginDash.generateJs(checkIfInDiv, firstDiv, isFatherFunction, fatherName, false, false, ""));
        }

        if (pDash != null) {
            js.append(pDash.generateJs(checkIfInDiv, firstDiv, isFatherFunction, fatherName, false, false, ""));
        }

        if (textDash != null) {
            js.append(textDash.generateJs(checkIfInDiv, firstDiv, isFatherFunction, fatherName, false, false, ""));
        }
        ...
        if (widthDash != null) {
            js.append(widthDash.generateJs(checkIfInDiv, firstDiv, isFatherFunction, fatherName, false, false, ""));
        }

        if (heightDash != null) {
            js.append(heightDash.generateJs(checkIfInDiv, firstDiv, isFatherFunction, fatherName, false, false, ""));
        }
