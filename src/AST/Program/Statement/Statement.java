...
public class Statement implements Node {
    ...
    public String generateJs(Boolean checkIfInDiv, Boolean firstDiv, Boolean isFatherFunction, String fatherName, Boolean myFatherIsIf, Boolean divAfterJSX, String changeState) {
        ...
        if (component != null) {
            js.append(component.generateJs(checkIfInDiv,firstDiv,isFatherFunction, fatherName, false, false, "")).append("\n");
        }
        if (callComponent != null) {
            js.append(callComponent.generateJs(checkIfInDiv,firstDiv,isFatherFunction, fatherName, myFatherIsIf, false, changeState)).append("\n");
        }
        if (assignment != null) {
            js.append(assignment.generateJs(checkIfInDiv,firstDiv,isFatherFunction, fatherName, false, false, "")).append("\n");
        }
        if (ifStatement != null) {
            js.append(ifStatement.generateJs(checkIfInDiv,firstDiv,isFatherFunction, fatherName, false, false, "")).append("\n");
        }
        if (forStatement != null) {
            js.append(forStatement.generateJs(checkIfInDiv,firstDiv,isFatherFunction, fatherName, false, divAfterJSX, "")).append("\n");
        }
        if (functionCall != null) {
            js.append(functionCall.generateJs(false,firstDiv,isFatherFunction, fatherName, false, false, "")).append("\n");
        }
        if (function != null) {
            js.append(function.generateJs(checkIfInDiv,firstDiv,isFatherFunction, fatherName, false, false, "")).append("\n");
        }
        if (timeFunction != null) {
            js.append(timeFunction.generateJs(checkIfInDiv,firstDiv,isFatherFunction, fatherName, false, false, "")).append("\n");
        }
        if (array != null) {
            js.append(array.generateJs(checkIfInDiv,firstDiv,isFatherFunction, fatherName, false, false, "")).append("\n");
        }
        if (object != null) {
            js.append(object.generateJs(checkIfInDiv,firstDiv,isFatherFunction, fatherName, false, false, "")).append("\n");
        }
        if (htmlTag != null) {
            js.append(htmlTag.generateJs(checkIfInDiv,firstDiv,isFatherFunction, fatherName, false, false, "")).append("\n");
        }
        if (hooks != null) {
            js.append(hooks.generateJs(checkIfInDiv,firstDiv,isFatherFunction, fatherName, false, false, "")).append("\n");
        }
