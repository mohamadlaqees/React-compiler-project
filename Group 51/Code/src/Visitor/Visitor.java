...
public class Visitor extends ReactParserBaseVisitor {
    ...
    @Override
    public CallComponent visitCallComponent(ReactParser.CallComponentContext ctx) throws IOException {
    ...
    @Override
    public Assignment visitAssignment(ReactParser.AssignmentContext ctx) throws IOException {
    ...
    @Override
    public ArithmaticExpression visitArithmaticExpression(ReactParser.ArithmaticExpressionContext ctx) throws IOException {
    ...
    @Override
    public BooleanExpression visitBooleanExpression(ReactParser.BooleanExpressionContext ctx) throws IOException {
    ...
    @Override
    public ParenExpression visitParenExpression(ReactParser.ParenExpressionContext ctx) throws IOException {
    ...
    @Override
    public Boolean visitBoolean(ReactParser.BooleanContext ctx) throws IOException {
    ...
    @Override
    public ArithmaticOperator visitArithmaticOperator(ReactParser.ArithmaticOperatorContext ctx) throws IOException {
    ...
    @Override
    public CustomObject visitObject(ReactParser.ObjectContext ctx) throws IOException {
    ...
    public JSX visitJsx(ReactParser.JsxContext ctx) throws IOException {
        ...
        if (ctx.callComponent() != null) {
            for (int i = 0; i < ctx.callComponent().size(); i++) {
                jsx.setCallComponent(visitCallComponent(ctx.callComponent(i)));
            }
        }
        if (ctx.functionCall() != null) {
            for (int i = 0; i < ctx.functionCall().size(); i++) {
                jsx.setFunctionCall(visitFunctionCall(ctx.functionCall(i)));
            }
        }
        if (ctx.htmlTag() != null) {
            for (int i = 0; i < ctx.htmlTag().size(); i++) {
                jsx.setHtmlTag(visitHtmlTag(ctx.htmlTag(i)));
            }
        }
        if (ctx.ifStatement() != null) {
            for (int i = 0; i < ctx.ifStatement().size(); i++) {
                jsx.setIfStatement(visitIfStatement(ctx.ifStatement(i)));
            }
        }
        return jsx;
    }
    ...
    @Override
    public SRC visitSrc(ReactParser.SrcContext ctx) throws IOException {
        SRC src = new SRC();
    ...
    @Override
    public ClassName visitClassName(ReactParser.ClassNameContext ctx) throws IOException {
    ...
    @Override
    public CssProps visitCssProps(ReactParser.CssPropsContext ctx) throws IOException {
    ...
    @Override
    public GabDash visitGabDash(ReactParser.GabDashContext ctx) throws IOException {
    ...
    @Override
    public BorderDash visitBorderDash(ReactParser.BorderDashContext ctx) throws IOException {
    ...
    @Override
    public BorderBottomDash visitBorderBottomDash(ReactParser.BorderBottomDashContext ctx) throws IOException {
    ...
    @Override
    public MarginDash visitMarginDash(ReactParser.MarginDashContext ctx) throws IOException {
    ...
    @Override
    public PDash visitPDash(ReactParser.PDashContext ctx) throws IOException {
    ...
    @Override
    public TextDash visitTextDash(ReactParser.TextDashContext ctx) throws IOException {
    ...
    @Override
    public WidthDash visitWidthDash(ReactParser.WidthDashContext ctx) throws IOException {
    ...
    @Override
    public HeightDash visitHeightDash(ReactParser.HeightDashContext ctx) throws IOException {
    ...
    public Onclick visitOnClick(ReactParser.OnClickContext ctx) throws IOException {
        ...
        if (ctx.statement() != null) {
            for (int i = 0; i < ctx.statement().size(); i++) {
                onclick.setStatement(visitStatement(ctx.statement(i)));
            }
        }
        if (ctx.jsx() != null) {
            onclick.setJsx(visitJsx(ctx.jsx()));
        }
    ...
    @Override
    public TOP visitTop(ReactParser.TopContext ctx) throws IOException {
        TOP top = new TOP();
    ...
    @Override
    public BOTTOM visitBottom(ReactParser.BottomContext ctx) throws IOException {
    ...
    @Override
    public RIGHT visitRight(ReactParser.RightContext ctx) throws IOException {
    ...
    @Override
    public LEFT visitLeft(ReactParser.LeftContext ctx) throws IOException {
        LEFT left = new LEFT();
